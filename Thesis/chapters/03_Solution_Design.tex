...
\subsection{Views}
The system is designed to contain three pages: a home page where a user can create a new project or open an existing project, a workspace page where the modeling workflow happens, and a statistic page where the user can view the statistics of the project.
