    ...
    load: function (l, m) {
      ...
      var r = function (b) {
        ...
        if (b.documentElement.nodeName !== "svg") {
          ...
          p(!c.length ? "???" : (d.length ? d[0] : c[0]).firstChild.nodeValue);
          return;
        }
        ...
        for (var i = 0; i < b.documentElement.attributes.length; i++) {
          ...
          if (
            !(
              h.nodeName === "version" || h.nodeName.substring(0, 5) === "xmlns"
            )
          ) {
        ...
        for (var i = 0; i < j.length; i++) {
          try {
            f.appendChild(o._svg.ownerDocument.importNode(j[i], true));
        ...
        if (a.attributes) {
          for (var i = 0; i < a.attributes.length; i++) {
            ...
            if (
              ...
              b +=
                " " +
                (c.namespaceURI === $.svg.xlinkNS ? "xlink:" : "") +
                c.nodeName +
                '="' +
                c.nodeValue +
                '"';
