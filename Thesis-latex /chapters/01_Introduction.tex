...
The remainder of this thesis is structured as follows: Chapter~\ref{sec:rel} reviews the related work on process modeling from documents and LLM-based process modeling. Chapter~\ref{sec:solution} presents the design of the proposed system, including its requirements, architecture, and functionalities. Chapter~\ref{sec:evaluation} describes the evaluation of the proposed system, including the methodology, results. Chapter~\ref{sec:discussion} discusses the implications of the findings and potential future work. Finally, Chapter~\ref{sec:conclusion} concludes the thesis and outlines future work.
