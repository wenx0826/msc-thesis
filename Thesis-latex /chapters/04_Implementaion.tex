...
\section{Backend}
The backend is using Fastify, as its out-of-box support for schame validation. As shown in the figure~\ref{fig:imp_backend_com}, the example code snippet of the backend
\begin{lstlisting}[language=Python]
\label{code:imp_backend_schema_example}
def hello():
    print("Hello World")
\end{lstlisting}
