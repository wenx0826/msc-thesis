...
The remainder of this thesis is structured as follows: Chapter~\ref{sec:rel} reviews the related work in AI-assisted process modeling tools. Chapter~\ref{sec:solution} presents the design solution of the tool. Chapter~\ref{sec:implementation} describes the technical implementation. Chapter~\ref{sec:evaluation} details the evaluation. Chapter~\ref{sec:discussion} discusses the evaluation findings. Finally, Chapter~\ref{sec:conclusion} summarizes the thesis.
